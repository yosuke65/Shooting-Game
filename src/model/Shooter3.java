...
public class Shooter3 extends Shooter {
    ...
    public Shooter3(int x, int y, boolean shield) {
        super(x, y);
    ...
    public void render(Graphics2D g) {
        if (state == GameFigureState.GAMEOVER) {
...
//        g.fill(collisionBox);
    ...
    public void getImage() {
        try {
            image = ImageIO.read(getClass().getResource("playerShip3_red.png"));
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Error: Cannot open playerShip3_red.png");
            System.exit(-1);
        }
        try {
    ...
    public void drawFire(Graphics2D g) {
        g.drawImage(fireImage[fireImageType], (int) super.x+20, (int) super.y+50,
                FIRE_WIDTH+10, FIRE_HEIGHT+10, null);
    }
