...
public class ItemShield extends EnemyFigure {
    ...
    private void getImage() {
        try {
            asteroidImage = ImageIO.read(getClass().getResource("shield_gold.png"));
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Error: Cannot open shield_gold.png");
            System.exit(-1);
        }
    }
