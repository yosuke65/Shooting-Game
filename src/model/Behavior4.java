...
public class Behavior4 implements Animation {
    ...
    public Behavior4(float x, float y, int width, int height, int unitTravel, Image image) {
        this.x = x;
        this.y = y;
        this.image = image;
        enemyWidth = width;
        ...
        TRIGGER_SHOOT = 50 - Main.gameData.gameLevel;
