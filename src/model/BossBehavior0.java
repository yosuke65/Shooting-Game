...
public class BossBehavior0 implements Animation {
...
//    private final int DIRECTION_LEFT = 2;
    ...
    public BossBehavior0(float x, float y, int width, int height, int unitTravel, Image image) {
        this.x = x;
        this.y = y;
        this.image = image;
        enemyWidth = width;
...
//        TRIGGER_SHOOT = rand.nextInt(100) + 50;
