...
public class StageBoss3 extends StageBoss {
...
//    private Animation behavior2;
    ...
    public StageBoss3(float x, float y) {
...
//                WIDTH, HEIGHT, null);
    ...
    private void getImage() {
        try {
            spaceshipImage = ImageIO.read(getClass().getResource("enemyBlack5.png"));
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Error: Cannot open enemyBlack5.png");
            System.exit(-1);
        }
...
//        }
    ...
    public void setHealth() {
        health = 5;
//        super.health = 30 + Main.gameData.gameLevel;
    }
