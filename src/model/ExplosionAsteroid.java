...
public class ExplosionAsteroid extends GameFigure {
    ...
    public ExplosionAsteroid(float x, float y) {
        super(x, y);
...
//        for (int i = 0; i < 20; i++) {
//            try {
//                image.add(ImageIO.read(getClass().getResource("tank_explosion1.png")));
...
//        }
        for (int i = 0; i < 10; i++) {
            try {
                image.add(ImageIO.read(getClass().getResource("tank_explosion2.png")));
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(null, "Error: Cannot open tank_explosion1.png");
                System.exit(-1);
            }
        ...
        for (int i = 0; i < 10; i++) {
            try {
                image.add(ImageIO.read(getClass().getResource("tank_explosion3.png")));
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(null, "Error: Cannot open tank_explosion1.png");
                System.exit(-1);
            }
        ...
        for (int i = 0; i < 10; i++) {
            try {
                image.add(ImageIO.read(getClass().getResource("tank_explosion4.png")));
            } catch (IOException ex) {
                JOptionPane.showMessageDialog(null, "Error: Cannot open tank_explosion1.png");
                System.exit(-1);
            }
