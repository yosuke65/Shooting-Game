...
public class ItemPowerUpShip extends EnemyFigure {
    ...
    public ItemPowerUpShip(float x, float y) {
    ...
    private void getImage() {
        try {
            asteroidImage = ImageIO.read(getClass().getResource("powerupRed_bolt.png"));
        } catch (IOException ex) {
            JOptionPane.showMessageDialog(null, "Error: Cannot open powerupRed_bolt.png");
            System.exit(-1);
        }
    }
