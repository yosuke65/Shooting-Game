...
public class StageBoss1 extends StageBoss {
...
//    private Animation behavior2;
    ...
    public StageBoss1(float x, float y) {
...
//                WIDTH, HEIGHT, null);
    ...
    @Override
    public void update() {
        //System.out.println("x: " + x + " y: " + y + " State: " + state+" Distance: "+ enterDistance);
        stateUpdate();
        if (state == GameFigureState.STATE_BOSS_APPEAR) {
            animation.update();
//            enterDistance += ENTER_TRAVEL;
        } else {
